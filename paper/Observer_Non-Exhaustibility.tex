...
questions in philosophy and one of the newest in formal science.  Plato
raised the problem of reflexive knowledge.  Kant drew constitutive limits
around the self's possible cognition of itself.  Husserl and Merleau-Ponty
transformed the issue into a problem of givenness and lived presence.
G\"odel, Turing, Lawvere, and Yanofsky explored the structural
consequences of self-reference and diagonalization.  Hofstadter gave
vivid informal rhetoric about reflexive loops and self-modeling.  The
...
observerhood be fully captured by one of these strategies.  The task of
the paper is to show that none succeeds and to identify what remains.
...
We do not claim that every informal theory of observerhood literally
announces one of these route names.  We claim instead that the principal
\emph{internal reductive strategies for observer exhaustion}, once
formalized, fall into these route classes.
...
internal self-models, and parametric families.  Lawvere is closer:\ he
formalizes diagonal structure at the level of maps.  But Lawvere does not
give the observer-architecture classification proved here.
...
source satisfying~$I$.  The slogan:
\begin{quote}
...
invariant class does not amount to architectural transition.  Closure can
elaborate what is already reachable, but it cannot cross an invariant
boundary requiring a fold.
...
This route speaks to a recurring hope in both philosophy and AI: that
enough recursion or self-reinforcement might collapse the distinction
between process and self-possession.  The \RFO{} result gives the
theorem-backed reply: iteration and closure do not constitute
...
presence from objectifying representation.  The novelty is threefold.
...
The observer is the structured residual that remains after the principal
reductive routes are exhausted: a non-collapsing architecture of ground,
articulation, and manifestation, localized in awareness and irreducible to
the routes that sought to exhaust it.
\end{keybox}

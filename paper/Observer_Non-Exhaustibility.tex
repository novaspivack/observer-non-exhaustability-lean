...
\url{https://github.com/novaspivack/observer-non-exhaustibility-lean}
(\texttt{observer-non-exhaustability-lean} development; \texttt{lake build}; repository \texttt{README} and \texttt{lakefile.lean}.)
...
under namespace \texttt{Observer.Nonexhaustability} in the
\texttt{observer-non-exhaustability-lean} submodule.  The same rows are
maintained in the outer repository as \texttt{MANIFEST.md} (\ONE{}
packaging \Lean{} table), \texttt{ARTIFACT.md}, and
\texttt{NOTES/FORMALIZATION\_MAP.md}.  Discharged-engine proof obligations
live in the libraries cited in \cref{sec:status}; the concatenated
cross-library manifest is \texttt{NOTES/Combined\_Lean\_Manifests.md}.

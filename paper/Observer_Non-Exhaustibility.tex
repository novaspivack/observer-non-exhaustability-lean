...
one classification story---not reproved inside \ONE.
\end{keybox}
...
The heavy proofs live in \RI, \RFO, \ICA/\SEM, and the reflexive-closure
libraries.  \ONE{} contributes the case partition vocabulary, import
wrappers, summit conjunction, and route-partition residual theorem---a
thin certification layer, not a fourth independent obstruction program.
\end{keybox}
...
paper, the observer is non-exhaustible.
